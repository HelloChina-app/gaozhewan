    ...
    <section className="page-shell">
      ...
      <div className="value-list">
        <div className="value-row">
          <h3>我们收集什么</h3>
          <p>
            订阅邮箱、订阅来源、你选择的开搞方向、提交时间、基础站点访问统计；购买 Pro 时还会处理接收访问权的邮箱、USDT 网络、交易哈希、可选的付款钱包地址和备注。
          </p>
        </div>
        <div className="value-row">
          <h3>我们如何使用</h3>
          <p>
            用于发送邮件内容、通过 TRON 公共链上事件核对 USDT 付款、阻止同一 TxID 重复开通、发放和验证 Pro 访问权限、处理售后、优化选题方向及统计页面表现。
          </p>
        </div>
        <div className="value-row">
          <h3>我们不会做什么</h3>
